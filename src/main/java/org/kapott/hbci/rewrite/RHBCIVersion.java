...
/**
 * <p>
 * Korrektur fehlender HBCI-Versionsnummern. Einige HBCI-Server
 ...
 * erwartete Wert eingetragen.
 * </p>
 * <p>
 * Die Überprüfung, ob die HBCI-Versionsnummern in gesendeter und
 ...
 * {@link org.kapott.hbci.manager.HBCIUtils})
 * </p>
 */
		...
		extends Rewrite
{
	 ...
	 */
	private static final Logger logger = LoggerFactory.getLogger( RHBCIVersion.class );
		...
		{ // + after SegHead found
			...
			{ // + after msgsize found
				...
				{ // + after hbciversion found
					...
					{
						logger.warn( "received HBCI version of message ('" + version + "') is incorrect - replacing it with " + origVersion );
