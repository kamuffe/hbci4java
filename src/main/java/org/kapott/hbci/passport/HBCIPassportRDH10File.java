		...
		extends HBCIPassportRDHXFile
{
	 ...
	 */
	private static final Logger logger = LoggerFactory.getLogger( HBCIPassportRDH10File.class );

	protected String getCompatName()
	{
		logger.warn( "RDH10File should not be used any longer - use RDHXFile instead!" );
		return "RDH10File";
	}

	public HBCIPassportRDH10File( HBCICallback callback, Object initObject )
	{
