...
/**
 * <p>
 * Passport-Implementation für anonyme Zugänge. Bei dieser Passport-Variante
 ...
 * (z.B. Gastmeldung an Bank senden).
 * </p>
 * <p>
 * Beim Einrichten eines solchen Passport-Objektes werden also keine
 ...
 * keine Schlüssel verwendet werden.
 * </p>
 * <p>
 * Eine HBCI-Anwendung kann ein Anonymous-Passport genauso verwenden wie
 ...
 * </p>
 * <p>
 * Gegenwärtig können mit Anonymous-Passports noch keine anonymen Geschäftsvorfälle
		...
		extends AbstractHBCIPassport
{
	 ...
	 */
	private static final Logger logger = LoggerFactory.getLogger( HBCIPassportAnonymous.class );
	...
	public HBCIPassportAnonymous( HBCICallback callback, Object initObject )
	{
