		...
		extends AbstractHBCIPassport
{
	 ...
	 */
	private static final Logger logger = LoggerFactory.getLogger( AbstractRDHPassport.class );
	...
	public String getSigFunction()
	{
		...
		logger.debug( "using sig function {}", ret );
		return ret;
	}
	...
	public String getSigMode()
	{
		...
		logger.debug( "using sig mode {}", ret );
		return ret;
	}
	...
	public String getCryptMode()
	{
		...
		logger.debug( "using crypt mode {}", ret );
		return ret;
	}
	...
	protected int getCryptDataSize( Key key )
	{
		...
		logger.debug( "using crypt data size {}", ret );
		return ret;
	}
	...
	public String getHashAlg()
	{
		...
		logger.debug( "using hash alg {}", ret );
		return ret;
	}
	...
	public SignatureParamSpec getSignatureParamSpec()
	{
		...
		logger.debug( "using hash instance " + hashalg + "/" + hashprovider );
	...
	protected Signature getSignatureInstance()
	{
		...
		logger.debug( "using sig instance " + sigalg + "/" + sigprovider );
		try
		{
