    ...
    implements HBCIPassportInternal,Serializable
{
    ...
    public AbstractHBCIPassport(HBCICallback callback, Object init)
    {
        ...
        this.persistentData=new Hashtable<String, Object>();
                                        ...
                                        boolean needUserId,boolean needCustomerId)
    {
        ...
        if (needBLZ && 
            ...
            getCallback().callback(this,HBCICallback.NEED_BLZ,HBCIUtilsInternal.getLocMsg("BLZ"),HBCICallback.TYPE_TEXT,sb);
            if (sb.length()==0)
        ...
        if (needCountry &&
            ...
            getCallback().callback(this,HBCICallback.NEED_COUNTRY,HBCIUtilsInternal.getLocMsg("COUNTRY"),HBCICallback.TYPE_TEXT,sb);
            if (sb.length()==0)
            ...
            (getHost()==null || getHost().length()==0)) 
        {
            ...
            getCallback().callback(this,HBCICallback.NEED_HOST,HBCIUtilsInternal.getLocMsg("HOST"),HBCICallback.TYPE_TEXT,sb);
            if (sb.length()==0)
        ...
        if (needPort && 
            ...
            getCallback().callback(this,HBCICallback.NEED_PORT,HBCIUtilsInternal.getLocMsg("PORT"),HBCICallback.TYPE_TEXT,sb);
            if (sb.length()==0)
        ...
        if (needFilter &&
            ...
            getCallback().callback(this,HBCICallback.NEED_FILTER,HBCIUtilsInternal.getLocMsg("FILTER"),HBCICallback.TYPE_TEXT,sb);
            if (sb.length()==0)
        ...
        if (needUserId &&
            ...
            StringBuffer sb=new StringBuffer();
            getCallback().callback(this,HBCICallback.NEED_USERID,HBCIUtilsInternal.getLocMsg("USERID"),HBCICallback.TYPE_TEXT,sb);
            if (sb.length()==0)
        ...
        if (needCustomerId &&
            ...
            getCallback().callback(this,HBCICallback.NEED_CUSTOMERID,HBCIUtilsInternal.getLocMsg("CUSTOMERID"),HBCICallback.TYPE_TEXT,sb);
    ...
    public static HBCIPassport getInstance(String name, HBCICallback callback)
    {
    	return getInstance( name, callback , null);
    }
    ...
    public static HBCIPassport getInstance(String name, HBCICallback callback, Object init)
    {
        if (name==null) {
        ...
        try {
            ...
            Constructor con=cl.getConstructor(new Class[] {HBCICallback.class, Object.class});
            HBCIPassport p=(HBCIPassport)(con.newInstance(new Object[] {callback, init}));
            return p;
        }
