 ...
 * das mit dieser Passport-Variante geschehen.
 * </p>
 */
		...
		extends AbstractRDHSWFileBasedPassport
{
	 ...
	 */
	private static final Logger logger = LoggerFactory.getLogger( HBCIPassportRDHXFile.class );
	...
	public HBCIPassportRDHXFile( HBCICallback callback, Object initObject )
	{
		...
		if ( init )
		{
			logger.debug( "loading data from file {}", getFilename() );
