...
/**
 * <p>
 * Passport-Klasse für die Verwendung von SIZ-RDH-Schlüsseldateien mit <em>HBCI4Java</em>.
 ...
 * {@link org.kapott.hbci.tools.ConvertSIZRDHPassport} verwendet werden.
 * </p>
 * <p>
 * <b>Achtung: In der reinen GPL-Version von <em>HBCI4Java</em> ist diese Klasse nicht
		...
		extends AbstractRDHSWFileBasedPassport
{
	 ...
	 */
	private static final Logger logger = LoggerFactory.getLogger( HBCIPassportSIZRDHFile.class );
	...
	public HBCIPassportSIZRDHFile( HBCICallback callback, Object init, int dummy )
	{
		super( callback, init );
	}

	public HBCIPassportSIZRDHFile( HBCICallback callback, Object initObject )
	{
