		...
		extends HBCICardService
{
	 ...
	 */
	private static final Logger logger = LoggerFactory.getLogger( RSACardService.class );
...
//    }
	...
	public RSABankData readBankData( int idx )
	{
		...
		try
		{
			...
			logger.debug( "A604 prefix = " + prefix[0] );
			int max = prefix[0] >> 4;
	...
	public void writeBankData( int idx, RSABankData bankData )
	{
		...
		logger.debug( "bankData={}", toHex( rawData ) );
//        selectFile(0xA603);
...
//        
//        HBCIUtils.log("sidId=" + toHex(rawData));
//        //selectFile(0xA601);
//        //updateRecordBySFI(0x00, idx, rawData);
	}
