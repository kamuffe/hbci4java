...
public final class HBCIStatus
{
	 ...
	 */
	private static final Logger logger = LoggerFactory.getLogger( HBCIStatus.class );
	...
	public void addRetVal( HBCIRetVal ret )
	{
		...
		if ( ret.isError() )
		{
			logger.error( "HBCI error code: {}", ret );
		}
	}
