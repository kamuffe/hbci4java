...
/**
 * <p>
 * Enthält alle Status-Informationen zu genau einem Nachrichtenaustausch.
 ...
 * sowie die eigentlichen Fehler-Informationen zurückgeben.
 * </p>
 */
public final class HBCIMsgStatus
{
	...
	public boolean isInvalidPIN()
	{
		...
		List<HBCIRetVal> retvals = new ArrayList<>( Arrays.asList( globStatus.getErrors() ) );
