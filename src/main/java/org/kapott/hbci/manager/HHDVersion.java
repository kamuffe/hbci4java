...
public enum HHDVersion
{
	 ...
	 */
	private static final Logger logger = LoggerFactory.getLogger( HHDVersion.class );
	 ...
	 * @param idStart
	 *        Technische Kennung beginnt mit diesem Text.
	 ...
	 * @param versionStart
	 *        ZKA-Version bei HKTAN.
	 * @param segVersion
	 *        Segment-Version des HKTAN-Elements.
	 * @param challengeVersion
	...
	public static HHDVersion find( Properties secmech )
	{
		...
		logger.debug( "  ZKA version: {}", version );
		...
		logger.debug( "  segment version: {}", segversion );
