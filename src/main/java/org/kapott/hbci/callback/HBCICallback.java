 ...
 * Methode dieses Passwort direkt zurückgeben, ohne den Anwender erneut danach zu fragen.
 * </p>
 */
public interface HBCICallback
{
	 ...
	 * die Beschreibung des Rückgabe-Datentyps {@link #TYPE_BOOLEAN})).
	 * </p>
	 * <p>
	 ...
	 * </p>
	 */
	public static final int NEED_NEW_INST_KEYS_ACK = 12;
	/**
	 ...
	 * <p>
	 * Nach der Schlüsselerzeugung und dem erfolgreichen Versand der Schlüsseldaten erzeugt <em>HBCI4Java</em>
	 ...
	 * benutzt werden, was Teil von <em>HBCI4Java</em> ist.
	 * </p>
	 * <p>
	 * Nachdem dieser Callback abgearbeitet wurde, wirft <em>HBCI4Java</em> eine Exception (<code>NeedKeyAckException</code>)
	 ...
	 * </p>
	 */
	public static final int HAVE_NEW_MY_KEYS = 13;
	/**
	 ...
	 * <em>HBCI4Java</em> die Kontodaten trotz des fehlgeschlagenen Prüfziffern-Checks
	 * </p>
	 * <p>
	 ...
	 * Rückgabe-Datentyps {@link #TYPE_BOOLEAN}.
	 * </p>
	 * <p>
	 * Das Ignorieren eines Fehlers kann dazu führen, dass <em>HBCI4Java</em> später trotzdem eine
	 ...
	 * Es wird aber in jedem Fall eine entsprechende Fehlermeldung erzeugt.
	 * </p>
	 */
	 ...
	 * </p>
	 * <p>
	 * Dazu wird beim Aufruf der Callback-Routine im Parameter <code>retData</code>
	 ...
	 * Eintrages im <code>retData</code>-Rückgabedatenobjekt zurückgeben.
	 * </p>
	 * <p>
	 * Beim Aufruf der Callback-Routine könnte <code>retData</code> also folgendes
	 ...
	 * muss in <code>retData</code> dann jeweils "0", "1" oder "4" zurückgegeben werden.
	 * </p>
	 */
	 ...
	 * nicht mehr benötigt wird, wird ein anderer Callback ({@link #CLOSE_CONNECTION}) erzeugt.
	 * </p>
	 * <p>
	 ...
	 * </p>
	 * <p>
	 * Normalweise wird bei PIN/TAN der <code>Base64</code>-Filter benutzt.
	 ...
	 * </p>
	 * <p>
	 * Dazu wird in <code>retData</code> ein String mit folgendem Format
	 ...
	 * <code>org.kapott.hbci.callback</code>.
	 * </p>
	 */
	 ...
	 */
	public static final int STATUS_MSG_RAW_RECV_ENCRYPTED = 32;
	 ...
	 * asynchron (<code>false</code>) behandelt werden soll.
	 * </p>
	 * <p>
