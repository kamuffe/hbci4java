 ...
 */
public class TestGVUebSEPA
		extends AbstractTestGV
{
	/**
	...
	public void test()
	{
		this.execute( new Execution()
		{
			...
			public HBCIJob getJob(HBCIHandler handler) {
				...
				return new GVUebSEPA(handler);
			}

			/**
			 * @see org.kapott.hbci4java.AbstractTestGV.Execution#configure(org.kapott.hbci.GV.HBCIJob,
			 *      org.kapott.hbci.passport.HBCIPassport, java.util.Properties)
			 */
			@Override
